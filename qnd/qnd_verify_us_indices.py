...
async def main():
    cache_json_content = read_file_as_single_string("./.cache_data/sp1500_cache.json")
    ...
    for row in data:
        ...
        found_sector = sector in data_utils.us_sector_yf_static_tickers
        ...
        print(
            f"Symbol: {symbol} / Sector: {sector} {'✅' if found_sector else '❌'} / Industry: {industry} {'✅' if found_industry else '❌'}"
        )
