...
BUILD_PROMPT_TEMPLATE = (
    ...
    "2. Prioritize the top 2-4 immediate actions the investor should take next. Each action MUST be clear and "
    "actionable, naming specific tickers and concrete numbers - for example: `Add bank stocks such as A, B, C "
