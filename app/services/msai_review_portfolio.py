...
BUILD_REBALANCE_PROMPT_TEMPLATE = (
    ...
    "4. Give exact, actionable trades for every affected position: BUY / HOLD / TRIM / SELL with rationale, "
    "current and target allocation, current and target number of shares, share delta, and approximate trade value.\n"
