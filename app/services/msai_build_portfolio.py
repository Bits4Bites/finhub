...
BUILD_PROMPT_TEMPLATE = (
    ...
    "\n"
    "## Your instructions\n"
    "- You are ONLY building a prompt. Do NOT design the portfolio, do NOT research markets, "
    "and do NOT produce any picks, allocations, or recommendations yourself.\n"
    "- All research, analysis, and portfolio construction must be performed by the premium model when it later "
    "executes the prompt you write.\n"
    "- The prompt you write must embed the investor profile (and existing holdings, if any) above so the premium "
    "model has full context.\n"
    "- The prompt must instruct the premium model to tailor the portfolio to the investor's profile, applying rules such as:\n"
    "  - Conservative profiles: weight toward dividend stocks, blue chips, bonds, or bond ETFs\n"
    "  - Aggressive profiles: allow higher allocation to growth stocks, small-caps, thematic ETFs\n"
    "  - Passive income goals: emphasize REITs, dividend ETFs, high-yield equities\n"
    "  - Short horizons: reduce volatility exposure, increase cash or short-duration assets\n"
    "  - ESG exclusions: screen out excluded sectors\n"
    "\n"
