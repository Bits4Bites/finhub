...
ExDivDate:{EX_DIV_DATE}|Div:{DIV_AMOUNT}|GrossYield:{DIV_YIELD}|Tax:30%|Franking:50%
...
# Step 1 - Web search
Search {TICKER} news (last 30d). Priority: ASX announcements > AFR/Reuters/Bloomberg/Livewire > ASIC/Shortman.
...
EffDiv        = Div×(1-Tax) + Div×(Tax/(1-Tax))×Franking
